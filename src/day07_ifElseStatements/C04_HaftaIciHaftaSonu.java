...
public class C04_HaftaIciHaftaSonu {
    public static void main(String[] args) {
        ...
        String gunIsmi=scan.next().toLowerCase();//kullanici nasil yazarsa yazsin biz kucuk harfle goruruz

        //String ifadelerde ==kullanilmasi tavsiye edilmez
        //cunku bekledigimizden farkli sonuc verir.
        ...
        gunIsmi.equals("carsamba")||gunIsmi.equals("persembe")||gunIsmi.equals("cuma")) {
            System.out.println("girdginiz gun haftaici");
        }
