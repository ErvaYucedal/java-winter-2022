...
public class StaticKeyword {
    ...
    public static void main(String[] args) {
        ...
        Class icerisinde yapilan her turlu degisiklik statik variablelarda kalici olur

        Instance variablelar ise objeye baglidir
        Instance variable'lara sadece obje uzerinden erisilebilir
        ve bir obje uzerinden erisilerek yapilan degisiklik
        instance variablenin degerini tum objeler icin kalici olarak degistirmez
