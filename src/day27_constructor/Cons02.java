...
public class Cons02 {
    public static void main(String[] args) {
        ...
        Ancak biz parametreli veya paremetresiz bir constructor
        yazdigimizda Java default constructor'i siler.

        Dolayisiyla biz herhangi bir constructor olusturdugumuzda
                 daha once baska claslar veya kullanicilarin olusturmus
                 olabilecegi objeleri kullanabilmeleri icin
                 default constructor'in islevini gerceklestirecek parametresiz
                 bir constructor olusturmakta fayda var
                 */
