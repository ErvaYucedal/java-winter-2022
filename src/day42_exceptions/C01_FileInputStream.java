...
public class C01_FileInputStream {
    public static void main(String[] args) {
        ...
        Oncelikle olasi exceptionlar parent-child ilişkisi taşiyor mu bakmamiz gerekir
        Eger parent child ilişkisi yoksa, istedigimiz sirada catch cumleleri olusturabiliriz
     ...
     exception konusu ile birlikte Compile Time Exception kavrami da hayatimiza girdi
         */
    }
}
