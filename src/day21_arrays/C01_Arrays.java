...
public class C01_Arrays {
    public static void main(String[] args) {
        ...
        // 1- deklare edip esitligin sagina suslu parantez icerisinde degerleri yazabiirim

        String arr7[]= {"Ali", "Veli", "Ayse"};
        // 2- icine deger atamadan olusturmak isterseniz, boyutunu belirlememiz gerekir

        int arr8[]= new int[6]; // java icinde 5 tane default deger olan bir array olusturur
                                // [0,0,0,0,0,0]
